package eu32k.vJoy.core.common.workset;

import java.util.ArrayList;
import java.util.List;

import eu32k.vJoy.core.common.workset.atomic.bool.And;
import eu32k.vJoy.core.common.workset.atomic.bool.False;
import eu32k.vJoy.core.common.workset.atomic.bool.Not;
import eu32k.vJoy.core.common.workset.atomic.bool.Or;
import eu32k.vJoy.core.common.workset.atomic.bool.Threshold;
import eu32k.vJoy.core.common.workset.atomic.bool.True;
import eu32k.vJoy.core.common.workset.atomic.bool.Xor;
import eu32k.vJoy.core.common.workset.atomic.image.AddAlpha;
import eu32k.vJoy.core.common.workset.atomic.image.AddImages;
import eu32k.vJoy.core.common.workset.atomic.image.BlackAndWhiteFilter;
import eu32k.vJoy.core.common.workset.atomic.image.ColorShader;
import eu32k.vJoy.core.common.workset.atomic.image.Filter;
import eu32k.vJoy.core.common.workset.atomic.image.GenShader;
import eu32k.vJoy.core.common.workset.atomic.image.HSVFilter;
import eu32k.vJoy.core.common.workset.atomic.image.Lazer;
import eu32k.vJoy.core.common.workset.atomic.image.MaskMixer;
import eu32k.vJoy.core.common.workset.atomic.image.RotateZoomFilter;
import eu32k.vJoy.core.common.workset.atomic.image.SimpleMixer;
import eu32k.vJoy.core.common.workset.atomic.image.TextureImage;
import eu32k.vJoy.core.common.workset.atomic.number.Add;
import eu32k.vJoy.core.common.workset.atomic.number.ContTimer;
import eu32k.vJoy.core.common.workset.atomic.number.MidiNumber;
import eu32k.vJoy.core.common.workset.atomic.number.Multiply;
import eu32k.vJoy.core.common.workset.atomic.number.Random;
import eu32k.vJoy.core.common.workset.atomic.number.SimpleFunction;
import eu32k.vJoy.core.common.workset.atomic.number.SimpleNumber;
import eu32k.vJoy.core.common.workset.atomic.number.Timer;
import eu32k.vJoy.core.common.workset.atomic.number.TriTimer;
...
public class Workset {
   ...
   private Workset() {
      ...
      Not not = new Not();
      Xor xor = new Xor();
      eu32k.vJoy.core.common.workset.atomic.bool.Random boolRandom = new eu32k.vJoy.core.common.workset.atomic.bool.Random();
